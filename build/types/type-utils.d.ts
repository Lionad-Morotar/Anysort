...
declare type isEveryCMDValid<PS1 extends PluginNames, PS2 extends PluginNamesWithArgMaybe, PS3 extends PluginNamesWithoutArg, ARR extends unknown[], CMD extends unknown[]> = CMD extends [infer P, ...infer R] ? P extends '' ? false : P extends `${infer Name}()` ? Name extends PS3 ? isEveryCMDValid<PS1, PS2, PS3, ARR, R> : false : P extends `${infer Name}(${infer Arg})` ? Name extends PS2 ? isEveryCMDValid<PS1, PS2, PS3, ARR, R> : false : isPathAvailable<ARR, P & string> extends true ? isEveryCMDValid<PS1, PS2, PS3, ARR, R> : false : true;
export declare type validOut<PS1 extends PluginNames, PS2 extends PluginNamesWithArgMaybe, PS3 extends PluginNamesWithoutArg, ARR extends unknown[], S, SS extends string[] = Split<S>> = S extends isStringLiteral<S> ? S extends '' ? never : isEveryCMDValid<PS1, PS2, PS3, ARR, SS> extends true ? S : never : never;
export {};
