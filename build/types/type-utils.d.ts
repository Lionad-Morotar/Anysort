...
declare type isEveryCMDValid<Plugins, ARR extends unknown[], CMD extends unknown[], PS2 = PluginNamesWithArg<Plugins>, PS3 = PluginNamesWithoutArg<Plugins>, PS4 = PluginNamesWithArgMaybe<Plugins>> = CMD extends [infer P, ...infer R] ? P extends '' ? false : P extends `${infer Name}()` ? Name extends (PS3 | PS4) ? isEveryCMDValid<Plugins, ARR, R> : false : P extends `${infer Name}(${infer Arg})` ? Name extends PS2 ? isEveryCMDValid<Plugins, ARR, R> : false : isPathAvailable<ARR, P & string> extends true ? isEveryCMDValid<Plugins, ARR, R> : false : true;
